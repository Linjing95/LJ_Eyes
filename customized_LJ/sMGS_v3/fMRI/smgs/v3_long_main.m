...
id = 1:8;
for ss = id
data_dir = ['C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\fMRI\pilot\fmri_' num2str(ss) '\Eye\'];

% We want to process each data folder separately
file_dirs = dir([data_dir 'smgs*\f*']); % run*\p* % smgs*\p*
