function set = v3_vgs_setting(edf)
...
set.msg = {'TRIALID','FixSrt','TarSrt','SacSrt','ItiSrt','TRIAL_RESULT 0'};
...
set.sac.msg = [3 4]; % we want to select saccades that start after message 11 or 12 (cue or saccade)
