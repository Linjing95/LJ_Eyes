...
% %data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\fMRI\pf4_1\fMRI_Eye\sMGS_v1_TR990_run2\';
% data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\Behavior\v3_short\'; % Behav_v3_long\sMGS\
% %data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\fMRI\pf9_1\Eye\';
% %data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\fMRI\sf10_1\Eye\';
% 
% % We want to process each data folder separately
% file_dirs1 = dir([data_dir 'sMGS*\p*']); % run*\p*
% file_dirs2 = dir([data_dir 'sMGS*\s*']); % run*\p*
...
% % e.g., 'D:/linjing_eyetracking/test'
% % MAKE SURE YOU END THE DIRECTORY WITH A SLASH!!!
% data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\Behavior\v3_short_delay\'; % Behav_v3_long\sMGS\
% % We want to process each data folder separately
% file_dirs = dir([data_dir 'SMGS*\s*']);

% v3_short_struct: smgs6, s32 (124) unable to open file; (131) s40, 148
% (smgs7, s34), 171 (s35, smgs8)
% Set up the data directory, where you store all your data,
% e.g., 'D:/linjing_eyetracking/test'
% MAKE SURE YOU END THE DIRECTORY WITH A SLASH!!!
data_dir = 'C:\Users\lj104\Documents\Linjing_Research\thesis_data\images\Behavior\v3_struct1324\'; % Behav_v3_long\sMGS\
% We want to process each data folder separately
file_dirs = dir([data_dir 'SMGS*\s*']);
...
% if contains(file_dirs(ii).name,'p3')%startsWith(file_dirs(ii).date,'04-Oct')
% ff_ind = [ff_ind ii];
% end
% end
%%
for ff = 172:length(file_dirs) %ff_ind%
...
% Load parameter file
edf = load_param_v3_long(edf,set);

% First, we need to detect different trials and task epochs
edf = detect_epoch_v3_long(edf,set);
...
edf = select_saccades_one_v3_long(edf,set); % select saccades
