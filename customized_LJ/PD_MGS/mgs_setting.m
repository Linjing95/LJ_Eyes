...
% we need to change to obeso's parameters
% distance from the eyes to the screen (in cm)
set.screen.d = 60;
...
% x resolution (in pixel)
set.screen.xres = 1920;

% y resolution (in pixel) of the monitor
set.screen.yres = 1080;
...
set.sac.msg = [4]; % we want to select saccades that start after message 11 or 12 (cue or saccade)
