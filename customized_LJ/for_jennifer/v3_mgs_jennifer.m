...
% To jennifer: you need to replace this path with your local path to the
% data. Under the data_dir, you should have two folders, "mgs1" and "mgs2",
% within each folder, you have one folder for each subject

% We want to process each data folder separately
file_dirs = dir([data_dir 'mgs*\s*']); 
% you may need to modify this. right now it finds all directories starting
% from "s" under folders starting with "mgs"
...
% open setting
% pause
set = v3_mgs_setting_jennifer(edf1);
