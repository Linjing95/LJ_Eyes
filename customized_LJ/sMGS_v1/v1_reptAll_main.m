...
data_dir = 'C:\Users\lj104\Documents\Linjing_Research\sMGS\v1\rept_All\LJ_0624\';
...
edf = select_saccades_all(edf,set);
...
% Number of saccades
n_sac = edf.cal.num_sac;

% Plot
figure(1);clf
boxWithDots2(p_err,{'1ST', '2ND', '3RD', '4TH'},[],[])
xlabel('Encoding Order')
ylabel('Primary Saccade Error (dva)')

figure(2);clf
boxWithDots2(a_err,{'1ST', '2ND', '3RD', '4TH'},[],[])
xlabel('Encoding Order')
ylabel('Smallest Saccade Error (dva)')

figure(3);clf
boxWithDots2(n_sac,{'1ST', '2ND', '3RD', '4TH'},[],[])
xlabel('Encoding Order')
